...
function index(req, res, next) {
  ...
  return _promise2.default.all([_index2.default.Sending.findAll(options), _index2.default.Sending.count()]).then(function (_ref) {
...
function create(req, res, next) {
  return _index2.default.Sending.create((0, _assign2.default)({}, req.body, {
...
//# sourceMappingURL=sending.controller.js.map
