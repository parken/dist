...
function index(req, res, next) {
  ...
  return _promise2.default.all([_sqldb2.default.Shipment.findAll(options), _sqldb2.default.Shipment.count()]).then(function (_ref) {
...
function show(req, res, next) {
  return _sqldb2.default.Shipment.findById(req.params.id).then(function (shipment) {
    return res.json(shipment);
  }).catch(next);
}

function create(req, res, next) {
  return _sqldb2.default.Shipment.create((0, _assign2.default)({}, req.body, {
...
function update(req, res, next) {
  return _sqldb2.default.Shipment.update((0, _assign2.default)({}, req.body, {
    active: false,
    updatedBy: req.user.id
...
function destroy(req, res, next) {
  return _sqldb2.default.Shipment.destory({ where: { id: req.params.id } }).then(function () {
    return res.status(201).end();
  }).catch(next);
}
