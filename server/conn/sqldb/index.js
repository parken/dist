...
['Group', 'SenderIdStatus', 'SenderId', 'Route', 'Upstream', 'LoginIdentifier', 'Contact', 'MessageStatus', 'Message', 'PackageType', 'UserPackage', 'Transaction', 'PriorityNumber', 'Group', 'GroupContact', 'Campaign', 'Template', 'MessageFly', 'Selling', 'Sending', 'TransactionStatus', 'UpstreamPlan'].forEach(function (model) {
